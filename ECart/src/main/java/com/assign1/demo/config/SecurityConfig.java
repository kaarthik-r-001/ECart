...
import com.assign1.demo.config.UserInfoManagerConfig;
import com.assign1.demo.config.jwtAuth.JwtRefreshTokenFilter;
import com.assign1.demo.config.jwtAuth.JwtTokenUtils;
import com.assign1.demo.repository.RefreshTokenRepo;
import com.assign1.demo.services.LogoutHandlerService;
...
import com.assign1.demo.config.jwtAuth.JwtAccessTokenFilter;
...
public class SecurityConfig extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {
    ...
    public SecurityFilterChain apiSecurityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                .securityMatcher(new AntPathRequestMatcher("/api/products/**"))
                .csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth.anyRequest().authenticated())
...
//    old method as mentioned in the tutorial
  /*
    @Bean
